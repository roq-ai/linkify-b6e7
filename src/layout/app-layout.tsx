...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    },
    {
      ...
      path: '/click-statistics',
      entity: 'click_statistics',
      service: AccessServiceEnum.PROJECT,
      icon: FiBarChart2,
    },
    { name: 'Links', path: '/links', entity: 'link', service: AccessServiceEnum.PROJECT, icon: FiExternalLink },
    {
      name: 'Link Clicks',
      path: '/link-clicks',
      entity: 'link_clicks',
    ...
    { name: 'Profiles', path: '/profiles', entity: 'profile', service: AccessServiceEnum.PROJECT, icon: FiUser },
    {
      name: 'Profile Views',
      path: '/profile-views',
    ...
    { name: 'Themes', path: '/themes', entity: 'theme', service: AccessServiceEnum.PROJECT, icon: FiFeather },
    {

  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Linkify - Your One-Stop Digital Hub! Embrace the simplicity of an analog of linktree, where all your links coexist harmoniously, paving the way for seamless connectivity."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Linkify - Your One-Stop Digital Hub! Embrace the simplicity of an analog of linktree, where all your links coexist harmoniously, paving the way for seamless connectivity.`}
            </Text>
            <Box

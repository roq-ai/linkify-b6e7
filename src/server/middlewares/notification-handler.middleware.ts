...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #12345 has been placed by Customer A.create': {
    roles: ['tenant-roles', 'tenant-owner-roles'],
    key: 'order_created',
    tenantPath: [],
    userPath: [],
  },
  'Payment of $100 has been received from Customer B.create': {
    roles: ['tenant-roles', 'tenant-owner-roles'],
    key: 'payment_received',
    tenantPath: [],
    userPath: [],
  },
  'Item XYZ has been added to the inventory by Tenant C.create': {
    roles: ['tenant-roles'],
    key: 'item_added',
    tenantPath: [],
    userPath: [],
